...
const TermsOfUsePage = () => {
  return (
    <>
      <Head>
        <title>Terms Of Use | Athoni - Look up Everything</title>
      </Head>
      <Breadcrumb
        parent="Terms Of Use"
        urlParent="terms-of-use"
        title="Terms Of Use"
      />
      <Container fluid={true} className="mb-5">
        <div className="tucupampam" style={{ zIndex: 100 }}>
          <h1 style={{ marginTop: 10 }}>Terms &amp; Conditions</h1>{" "}
          <p>Updated at 2020-12-09</p> <br /> <h1>General Terms</h1>{" "}
          <p className="p8">
            <span className="s1">
              By accessing and placing an order with <a />, you confirm that you
              are in agreement with and bound by the terms of service contained
              in the Terms &amp; Conditions outlined below. These terms apply to
              the entire website and any email or other type of communication
              between you and <a />.
              <br />
              <br />
              Under no circumstances shall <a /> team be liable for any direct,
              ...
              <a /> team or an authorized representative has been advised of the
              ...
              <br />
              <br /> <a /> will not be responsible for any outcome that may
          ...
          <p className="p10">
            <span className="s1">
              <a>Athoni</a> grants you a revocable, non-exclusive, non-
              ...
              <a>Athoni</a> (referred to in these Terms &amp; Conditions as "
              <a>Athoni</a>", "us", "we" or "our"), the provider of the{" "}
              <a>Athoni</a> website and the services accessible from the{" "}
              <a>Athoni</a> website (which are collectively referred to in these
              Terms &amp; Conditions as the "<a>Athoni</a> Service").
              <br />
              <br />
          ...
          <p className="p8">
            <span className="s1">For this Terms &amp; Conditions:</span>
          </p>{" "}
          <p className="p9">
            <br />
          </p>{" "}
          <ul className="ul1">
            ...
            <li className="li8">
              <span className="s1">
                ...
                “we,” “us,” or “our,” it refers to <a>Athoni</a> that is
            ...
            <li className="li8">
              <span className="s1">
                <strong>Country:</strong> where <a>Athoni</a> or the
                owners/founders of <a>Athoni</a> are based, in this case is{" "}
                <a>Us</a>.<br />
              </span>
            </li>{" "}
            <li className="li8">
              <span className="s1">
                ...
                or person that signs up to use the <a>Athoni</a> Service to
            ...
            <li className="li8">
              <span className="s1">
                ...
                visit <a>Athoni</a> and use the services.
                <br />
              </span>
            </li>{" "}
            <li className="li8">
            ...
            <li className="li8">
              <span className="s1">
                ...
                employed by <a>Athoni</a> or are under contract to perform a
            ...
            <li className="li8">
              <span className="s1">
                ...
                <a>Athoni</a> as described in the relative terms (if available)
            ...
            <li className="li8">
              <span className="s1">
                <strong>Website:</strong> <a>Athoni</a>’s site, which can be
                accessed via this URL: <a>___________</a>
                <br />
              </span>
            </li>{" "}
            <li className="li8">
              <span className="s1">
                ...
                <a>Athoni</a> to use the Services.
                <br />
              </span>
            </li>
          </ul>{" "}
          ...
          <p className="p10">
            <span className="s1">
              ...
              (ii) that the service will be uninterrupted or error-free; (iii)
              as to the accuracy, reliability, or currency of any information or
              content provided through the service; or (iv) that the service,
              its servers, the content, or e-mails sent from or on behalf of us
          ...
          <p className="p10">
            <span className="s1">
              ...
              of such term or any other term, and our failure to assert any
          ...
          <p className="p10">
            <span className="s1">
              ...
              REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Athoni’s
          ...
          <ul className="ul1">
            <li className="li16">
              <span className="s3">
                Via Email: <a>admin@athoni.com</a>
              </span>
            </li>{" "}
            {/**/}{" "}
            <li className="li16">
              <span className="s3">
                Via this Link: <a>https://www.athoni.com/contact-us</a>
              </span>
            </li>{" "}
            {/**/}
          </ul>
