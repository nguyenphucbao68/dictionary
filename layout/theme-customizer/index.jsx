...
const Themecustomizer = (props) => {
	...
	const [layout_type, setLayout_type] = useState(
		configDB.settings.layout_type
	);
						...
						>
							...
							<ModalBody>
								<Container fluid={true} className='bd-example-row'>
									<Row>
										<p>
											To replace our design with your desired theme.
											Please do configuration as mention{' '}
										</p>
										<p>
											{' '}
											<b>
												{' '}
												Path : data > customizer > config.jsx{' '}
											</b>{' '}
										</p>
									</Row>
									<pre>
